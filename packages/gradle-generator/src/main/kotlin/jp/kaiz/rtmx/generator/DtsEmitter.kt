...
object DtsEmitter {
    private const val JAVA_ARRAY_DECLARATION = """
...
interface JavaIteratorResult<T> {
  done: boolean;
  value: T;
}

interface JavaIterator<T> {
  next(): JavaIteratorResult<T>;
  return?(): JavaIteratorResult<T>;
}

interface JavaArrayLike<T> {
  readonly length: number;
  [index: number]: T;
  [Symbol.iterator](): JavaIterator<T>;
}

interface JavaObjectArray<T> extends JavaArrayLike<T> {}
interface JavaBooleanArray extends JavaArrayLike<boolean> {}
interface JavaByteArray extends JavaArrayLike<number> {}
interface JavaShortArray extends JavaArrayLike<number> {}
interface JavaIntArray extends JavaArrayLike<number> {}
interface JavaLongArray extends JavaArrayLike<number> {}
...
"""
    ...
    fun emit(classes: List<JavaClass>, outputDir: File) {
        outputDir.mkdirs()
        File(outputDir, "rtmx.d.ts").writeText(
            "// DO NOT EDIT!! This file is generated by rtmx. Any changes will be lost.\n" +
                JAVA_ARRAY_DECLARATION.trimEnd() +
                "\n"
        )
    ...
    internal fun typeToTs(type: Type): String {
        return when (type) {
            ...
            is GenericArrayType -> "JavaObjectArray<${typeToTs(type.genericComponentType)}>"
            else -> "any"
        }
    }
    ...
    private fun classToTs(cls: Class<*>): String {
        ...
        if (cls.isArray) return arrayClassToTs(cls.componentType)
        return when (cls) {
    ...
    private fun arrayClassToTs(component: Class<*>): String {
        return when (component) {
            java.lang.Boolean.TYPE -> "JavaBooleanArray"
            java.lang.Byte.TYPE -> "JavaByteArray"
            java.lang.Short.TYPE -> "JavaShortArray"
            java.lang.Integer.TYPE -> "JavaIntArray"
            java.lang.Long.TYPE -> "JavaLongArray"
            java.lang.Float.TYPE -> "JavaFloatArray"
            java.lang.Double.TYPE -> "JavaDoubleArray"
            java.lang.Character.TYPE -> "JavaCharArray"
            else -> "JavaObjectArray<${typeToTs(component)}>"
        }
    }
